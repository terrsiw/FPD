        ...
        children=[
            ...
            html.Div([
                ...
                html.P('Because the average user does not understand the theory of DM, '
                       'we try to get some prior estimate of the user preference and then find out more information '
                       'durion the DM. '
            ...
            html.Div([
                ...
                html.P('There is the possibility that you will like the results before the 25th result. '
                       'Then, you can click on the button "I like the results" (green button), and continue on the next '
                       'page with '
                       'final questionare. '),
                html.P('Or it can happen that you will be bored with rating, then you can click on "I am bored" (red '
                       'button),'
